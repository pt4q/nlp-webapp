...
import pl.com.pt4q.nlpwebapp.analyzers.english.AnalyzerServiceEn;
...
public class NERRestController {
    ...
    public Set<String> ner(@RequestBody final String input, @RequestParam TypeEnum type) {
        AnalyzerServiceEn analyzerServiceEn = AnalyzerServiceEn.getInstance();

        return new HashSet<String>(getWordsByType(analyzerServiceEn.ner(input), type));
    }
